...
public class CLTGScreenTesting {
 ...
 public void PrepopValuesLoadingTrailerAndSummarizeBillsWeight(String terminalcd,String SCAC,String TrailerNB,String Desti,String Cube,String AmountPro,String AmountWeight, Date MRSts) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
	 ...
	 SA.assertEquals(page.MinuteInput.getAttribute("value"), Minute);
		...
		String[] Proline1= ArrayUtils.remove(page.ProListSecondForm.findElement(By.xpath("div["+j+"]")).getText().split("\\n"), 0);
  ...
  public void PrepopValuesLoadingTrailerAndSummarizeBillsWeight2(String terminalcd,String SCAC,String TrailerNB,String Desti,String Cube,String AmountPro,String AmountWeight, Date MRSts) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
 	 SoftAssert SA= new SoftAssert();
 	 page.SetLocation(terminalcd);
 	 page.EnterTrailer(SCAC,TrailerNB);
