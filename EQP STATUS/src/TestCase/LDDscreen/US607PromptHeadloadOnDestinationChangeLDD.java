...
public class US607PromptHeadloadOnDestinationChangeLDD {
	...
	public void lddTrailerWithProsClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
	...
	public void lddTrailerWithHeadloadProsClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
			String cube, String HLDestination, String HLCube)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SAssert = new SoftAssert();
		page.SetLocation(terminalcd);
		...
		SAssert.assertEquals(NewEQPStatusRecord.get(12), EQPStatusRecord.get(12),
				"Headload_Capacity_Consumed_PC IS WRONG"); //
