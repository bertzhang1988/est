...
public class US607PromptHeadloadOnDestinationChangeLDG extends Setup {
	...
	public void ldgTrailerWithProsClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
		...
		SAssert.assertEquals(NewEQPStatusRecord.get(12), EQPStatusRecord.get(12),
				"eqps Headload_Capacity_Consumed_PC is wrong"); // Headload_Capacity_Consumed_PC
		SAssert.assertEquals(NewEQPStatusRecord.get(13), EQPStatusRecord.get(13),
				"eqps headload_dest_facility_cd is wrong"); // headload_dest_facility_cd
		SAssert.assertEquals(NewEQPStatusRecord.get(14), EQPStatusRecord.get(14),
				"eqps headload_origin_facility_CD is wrong");
		for (int i = 5; i <= 8; i++) {
	...
	public void ldgTrailerWithoutProsClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
			String cube, String HLDestination, String HLCube)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SAssert = new SoftAssert();
		page.SetLocation(terminalcd);
	...
	public void ldgTrailerWithHeadloadProsClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
			String cube, String HLDestination, String HLCube)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SAssert = new SoftAssert();
		page.SetLocation(terminalcd);
		...
		if (EQPStatusRecord.get(14) != null)
			SAssert.assertEquals(NewEQPStatusRecord.get(14), EQPStatusRecord.get(14),
					"eqps headload_origin_facility_CD is wrong");
		if (EQPStatusRecord.get(14) == null)
			SAssert.assertEquals(NewEQPStatusRecord.get(14), terminalcd, "eqps headload_origin_facility_CD is wrong");
	...
	@Test(priority = 7, dataProvider = "6.07", dataProviderClass = DataForUS607.class, description = "help test 6.07 ldd screen uc 2", groups = {
			"ldg uc" })
	public void ldgTrailerWithoutProsLDDClickNo(String terminalcd, String SCAC, String TrailerNB, String OrgiDesti,
			String cube, String HLDestination, String HLCube)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SAssert = new SoftAssert();
		page.SetLocation(terminalcd);
	...
	@Test(priority = 8, dataProvider = "6.07", dataProviderClass = DataForUS607.class, description = "help test 6.07 ldd screen uc 2", groups = {
			"ldg uc" })
