...
public class BORScreenTesting extends SetupBrowser {
	...
	public void SetTrailerWithoutProToBorFromONH(String terminalcd, String SCAC, String TrailerNB, String Desti,
	...
	public void twoBlOBRDockFromONH(String terminalcd, String SCAC, String TrailerNB, String Desti, String Cube,
		...
		Date d = CommonFunction.gettime("UTC");
		w1.until(ExpectedConditions.textToBePresentInElement(page.TitleOfScreen,
				"Set Trailer Status Bad Order Requested"));
		w2.until(ExpectedConditions.visibilityOf(page.TrailerInputField));
		w2.until(ExpectedConditions.textToBePresentInElementValue(page.TrailerInputField, ""));
		w1.until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("html/body/div[1]/div/div")));
		// check eqps
	...
	public void SmartEnterSetTrailerWithoutProToBorFromONH(String terminalcd, String SCAC, String TrailerNB,
		...
		page.EnterTrailer(SCAC, TrailerNB);
		// alter time
		page.SetDatePicker(page.GetDatePickerTime(), 0, -9);
		Date AlterTime = CommonFunction.ConvertUtcTime(terminalcd, page.GetDatePickerTime());
	...
	public void SetTrailerWithoutProToBorNOTFromONH(String terminalcd, String SCAC, String TrailerNB, String Desti,
			String Cube, String AmountPro, String AmountWeight, Date MRSts)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SA = new SoftAssert();
		page.SetLocation(terminalcd);
		...
		// alter time
		page.SetDatePicker(page.GetDatePickerTime(), 0, 20);
		Date AlterTime = CommonFunction.ConvertUtcTime(terminalcd, page.GetDatePickerTime());
		page.SubmitButton.click();
		Date d = CommonFunction.gettime("UTC");
		w1.until(ExpectedConditions.visibilityOf(page.AlertMessage));
	...
	public void SmartEnterSetTrailerWithoutProToBorNOTFromONH(String terminalcd, String SCAC, String TrailerNB,
			String Desti, String Cube, String AmountPro, String AmountWeight, Date MRSts)
			throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
		SoftAssert SA = new SoftAssert();
		Actions builder = new Actions(driver);
		...
		page.EnterTrailer(SCAC, TrailerNB);
		// alter time
		page.SetDatePicker(page.GetDatePickerTime(), 0, 16);
		Date AlterTime = CommonFunction.ConvertUtcTime(terminalcd, page.GetDatePickerTime());
		builder.sendKeys(Keys.ENTER).build().perform();
		Date d = CommonFunction.gettime("UTC");
		w1.until(ExpectedConditions.visibilityOf(page.AlertMessage));
