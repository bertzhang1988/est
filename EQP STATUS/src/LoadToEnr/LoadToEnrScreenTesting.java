...
public void VerifyInvalidTerminal(String terminalcd) throws AWTException, InterruptedException{
	...
	(new WebDriverWait(driver, 10)).until(ExpectedConditions.textToBePresentInElement(page.ErrorAndWarningField,"The terminal number is invalid. Please enter another terminal number."));
...
public void VerifyValidTerminal(String terminalcd) throws AWTException, InterruptedException{
	page.SetLocation(terminalcd);
	(new WebDriverWait(driver, 10)).until(ExpectedConditions.invisibilityOfElementWithText(By.xpath("html/body/div[1]/div"), "The terminal number is invalid. Please enter another terminal number."));
	Thread.sleep(500);
}
 
  
@Test(priority=1,dataProvider = "loadToEnrscreen",dataProviderClass=DataForUSLoadToEnrTest.class)
  public void ProDigitCheck(String terminal, String SCAC,String TrailerNb,String destination,String Cube,String StatusType, Date Mrst) throws AWTException, InterruptedException{
  ...
  public void CheckShipmentAlreadyLoadedOnTrailer(String terminal, String SCAC,String TrailerNb,String destination,String Cube,String StatusType, Date Mrst)  throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
    page.SetLocation(terminal);
	page.EnterTrailer(SCAC,TrailerNb);
  ...
  public void VerifyMasterRevenueVlidation(String terminalcd, String SCAC,String TrailerNB,String destination,String Cube,String StatusType, Date Mrst) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
	  SoftAssert SAssert= new SoftAssert();
	  	page.SetLocation(terminalcd);
	  	page.EnterTrailer(SCAC,TrailerNB); 
		...
		try{
		(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "Cannot add master bill."));
		}catch(Exception e){
		...
		page.SubmitButton.click();
		WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
		try{(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "Cannot add supplemental bill."));
		}catch(Exception e){
		...
		page.SubmitButton.click();
		WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
		try{(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "Cannot add voided PRO."));
		}catch(Exception e){
		...
		page.SubmitButton.click();
		WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
		try{(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "PRO already delivered."));
		}catch(Exception e){
  ...
  public void VerifyBatchProForFoodTrailer(String terminalcd, String SCAC,String TrailerNB,String destination,String Cube,String StatusType, Date Mrst) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
		SoftAssert SAssert= new SoftAssert();
		page.SetLocation(terminalcd);
		page.EnterTrailer(SCAC,TrailerNB);
  ...
  public void VerifyBatchProForPoisonTrailer(String terminalcd, String SCAC,String TrailerNB,String destination,String Cube,String StatusType, Date Mrst) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
	  SoftAssert SAssert= new SoftAssert();
		page.SetLocation(terminalcd);
		page.EnterTrailer(SCAC,TrailerNB);
		ArrayList<String> Addpro= new  ArrayList<String>();
  ...
  public void AddMultipleProsInSingleBatch(String terminalcd, String SCAC,String TrailerNB,String destination,String Cube,String StatusType, Date Mrst) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
