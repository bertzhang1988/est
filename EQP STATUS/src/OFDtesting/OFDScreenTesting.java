...
public class OFDScreenTesting {
 ...
 public void SmartEnterSetTrailerNoProToOFD1(String terminalcd,String SCAC,String TrailerNB,String CurrentStatus,String CRName,String CRType,Date PlanDelts, Date MRSts) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
 ...
 public void SmartEnterSetTrailerNoProToOFD2(String terminalcd,String SCAC,String TrailerNB,String CurrentStatus,String CRName,String CRType,Date PlanDelts, Date MRSts) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
	  SoftAssert SA= new SoftAssert();
	  page.SetLocation(terminalcd);
	  Date d1=CommonFunction.gettime("utc");
	  page.EnterTrailer(SCAC,TrailerNB); 
 ...
 public void SmartEnterSetTrailerWithProToOFD2(String terminalcd,String SCAC,String TrailerNB,String CurrentStatus,String CRName,String CRType,Date PlanDelts, Date MRSts) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
	  SoftAssert SA= new SoftAssert();
	  page.SetLocation(terminalcd);
	  Date d1=CommonFunction.gettime("utc");
	  page.EnterTrailer(SCAC,TrailerNB); 
