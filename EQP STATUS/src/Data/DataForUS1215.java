...
public class DataForUS1215 {
	...
	public static Iterator<Object[]> CreateData(Method m) throws ClassNotFoundException, SQLException {
		...
		String query1 = " select top 5 Equipment_Unit_NB, Standard_Carrier_Alpha_CD, Statusing_Facility_CD from"
		...
		} else if (m.getName().contains("NONLDGTrailerWithoutPROAddPRO")) {
