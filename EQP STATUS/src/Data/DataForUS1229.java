...
public class DataForUS1229 {
  ...
  public static Iterator<String[]> CreateData1(Method m) throws ClassNotFoundException, SQLException {	
     ...
     String query1 = 
" select top 2 ESi.Equipment_Unit_NB,ESi.Standard_Carrier_Alpha_CD,ESi.Statusing_Facility_CD, ESi.Equipment_Status_Type_CD, ESi.Actual_Capacity_Consumed_PC,esi.Seal_NB,ESi.Equipment_Dest_Facility_CD,COUNT(wb.pro_nb) AS AmountShip,sum(wb.Total_Actual_Weight_QT) AS AmountWeight"
...
+" and eqpa.[Standard_Carrier_Alpha_CD]=eqp.[Standard_Carrier_Alpha_CD] and eqpa.[Equipment_Unit_NB]=eqp.[Equipment_Unit_NB]  and neqps.[Equipment_Status_Type_CD]='"+Status+"'"
...
+" having COUNT(wb.pro_nb)=0 ORDER BY NEWID()";
     ...
     String query2=
"select TOP 2 neqps.[Standard_Carrier_Alpha_CD],neqps.[Equipment_Unit_NB],neqps.[Equipment_Status_Type_CD],neqps.[Statusing_Facility_CD],neqps.Actual_Capacity_Consumed_PC,nEqps.Equipment_Dest_Facility_CD"
...
+" where wb.Pro_NB=wbt.Pro_NB and wbt.Waybill_Transaction_Index_NB=(SELECT MAX(wbt2.Waybill_Transaction_Index_NB) FROM EQP.Waybill_Transaction wbt2 where wb.Pro_NB=wbt2.Pro_NB ) AND WB.PRO_nb='"+PRO+"'";
