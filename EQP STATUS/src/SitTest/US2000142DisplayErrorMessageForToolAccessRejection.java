...
public void CheckStatusTrailerButton(){
	...
	(new WebDriverWait(driver, 150)).until(ExpectedConditions.textToBePresentInElement(page.ErrorAndWarningField, "You do not have authority to update trailers for this terminal"));
}
