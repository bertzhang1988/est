...
//@Test(priority=1,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void MTYTrailerNoPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
...
(new WebDriverWait(driver, 150)).until(ExpectedConditions.textToBePresentInElement(page.UpdatedTrailerNum, newnumber));
Thread.sleep(2000);
...
//@Test(priority=2,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void OFDTrailerNoPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
int oldnumber=Integer.parseInt(page.UpdatedTrailerNum.getText());
...
//@Test(priority=3,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void SPTTrailerNoPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
int oldnumber=Integer.parseInt(page.UpdatedTrailerNum.getText());
...
public void MTYTrailerHasPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
...
public void SPTTrailerHasPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
(new WebDriverWait(driver, 50)).until(ExpectedConditions.textToBePresentInElement(page.Title, "Leftover Bill Review"));
...
public void OFDTrailerHasPRO(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
(new WebDriverWait(driver, 50)).until(ExpectedConditions.textToBePresentInElement(page.Title, "Leftover Bill Review"));
...
//@Test(priority=7,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void MTYTrailerHasPROCancel(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
SoftAssert SAssert= new SoftAssert();
page.SetLocation(terminalcd);	
page.EnterTrailer(SCAC,TrailerNB);	
...
//@Test(priority=8,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void SPTTrailerHasPROCancel(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
	SoftAssert SAssert= new SoftAssert();
	page.SetLocation(terminalcd);	
	page.EnterTrailer(SCAC,TrailerNB);	
	ArrayList<Object> OldEqpStatusRecord= DataForUS1229.CheckEQPStatusUpdate(SCAC, TrailerNB);
...
//@Test(priority=9,dataProvider = "12.29",dataProviderClass=DataForUS1229.class)
public void OFDTrailerHasPROCancel(String terminalcd, String SCAC, String TrailerNB,String destination) throws AWTException, InterruptedException, ClassNotFoundException, SQLException {
	SoftAssert SAssert= new SoftAssert();
	page.SetLocation(terminalcd);	
	page.EnterTrailer(SCAC,TrailerNB);	
	ArrayList<Object> OldEqpStatusRecord= DataForUS1229.CheckEQPStatusUpdate(SCAC, TrailerNB);
