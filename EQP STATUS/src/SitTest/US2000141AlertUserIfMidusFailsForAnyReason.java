...
public class US2000141AlertUserIfMidusFailsForAnyReason {
	...
	(new WebDriverWait(driver, 80)).until(ExpectedConditions.textToBePresentInElement(page.ErrorAndWarningField, "Update failed. Please open a ticket with the trailer, terminal and user ID for the EST app."));		
	// check eqps
