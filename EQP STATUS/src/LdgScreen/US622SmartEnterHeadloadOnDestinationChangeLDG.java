...
public class US622SmartEnterHeadloadOnDestinationChangeLDG {
 ...
 @Test(priority=1,dataProvider ="6.07",dataProviderClass=DataForUS607.class,description="2000.100", groups = { "ldg uc" })
...
@Test(priority=4,dataProvider ="6.07",dataProviderClass=DataForUS607.class,description="help test 6.07 ldd screen uc 2", groups = { "ldg uc" })
public void ldgTrailerWithoutProsLDDClickYes(String terminalcd,String SCAC,String TrailerNB, String OrgiDesti,String cube,String HLDestination,String HLCube) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
	 ...
	 // enter seal	
		...
		page.hlCancelButton.click();//click cancel
		 (new WebDriverWait(driver, 50)).until(ExpectedConditions.textToBePresentInElement(page.Title,"Set Trailer Status Closed"));
