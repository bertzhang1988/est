...
@Test(priority=2,dataProvider = "Invalid pro",dataProviderClass=DataForUS439.class)
  public void VerifyMRValidation(String PRO) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
...
@Test(priority=3,dataProvider = "Invalid pro",dataProviderClass=DataForUS439.class)
  public void VerifySUValidation(String PRO) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
   SoftAssert SAssert= new SoftAssert();
   page.CheckAllAddProButton.click();
   page.RemoveProButton.click();
   page.EnterPro(PRO);
   ...
   // change cube	
	...
	page.SubmitButton.click();
	WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
	(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "Cannot add supplemental bill."));
	(new WebDriverWait(driver, 50)).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("html/body/div[1]/div")));
	page.CheckAllAddProButton.click();
	page.RemoveProButton.click();	
	 }
...
@Test(priority=4,dataProvider = "Invalid pro",dataProviderClass=DataForUS439.class)
  public void VerifyVOValidation(String PRO) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
	SoftAssert SAssert= new SoftAssert();
	page.CheckAllAddProButton.click();
	page.RemoveProButton.click();
  	page.EnterPro(PRO);
	...
	page.SubmitButton.click();
	WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
	(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "Cannot add voided PRO."));
	(new WebDriverWait(driver, 50)).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("html/body/div[1]/div")));
	page.CheckAllAddProButton.click();
	page.RemoveProButton.click();
	 }
...
@Test(priority=5,dataProvider = "Invalid pro",dataProviderClass=DataForUS439.class)
  public void VerifyAlreadyDeliveredValidation(String PRO) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
    SoftAssert SAssert= new SoftAssert();
	page.CheckAllAddProButton.click();
	page.RemoveProButton.click();
  	page.EnterPro(PRO);
	...
	page.SubmitButton.click();
	WebElement Message=page.AddProForm.findElement(By.xpath("div["+NEW+"]/div/div[3]/div"));
	(new WebDriverWait(driver, 20)).until(ExpectedConditions.textToBePresentInElement(Message, "PRO already delivered."));
	(new WebDriverWait(driver, 50)).until(ExpectedConditions.invisibilityOfElementLocated(By.xpath("html/body/div[1]/div")));
	page.CheckAllAddProButton.click();
	page.RemoveProButton.click();
	 }
...
@Test(priority=6,dataProvider = "ldgtrailerNoPro",dataProviderClass=DataForUS439.class)
  public void VerifyMasterRevenueVlidation(String terminalcd,String SCAC,String TrailerNB) throws InterruptedException, AWTException, ClassNotFoundException, SQLException{
  	SoftAssert SAssert= new SoftAssert();
  	page.SetLocation(terminalcd);
  	page.EnterTrailer(SCAC,TrailerNB); 
