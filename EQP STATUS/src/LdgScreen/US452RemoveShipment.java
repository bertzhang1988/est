...
@Test(priority=1,dataProvider = "4.52",dataProviderClass=DataForUS452.class)
 public void VerifyDockPro(String terminalcd,String SCAC,String TrailerNB) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException {
 ...
 jse.executeScript("arguments[0].scrollIntoView(true);",page.ProListCheckboxListldg.findElement(By.xpath("div["+ran+"]/div/div/div/div")));
 page.ProListCheckboxListldg.findElement(By.xpath("div["+ran+"]/div/div/div/div")).click();
 String RemovedPro=page.ProListForm.findElement(By.xpath("div["+ran+"]/div/div[2]")).getText().replaceAll("-", "");
 ...
 if (page.ProListCheckAllProChecked.isDisplayed()) page.ProListCheckAllProChecked.click();
 //enter cube
...
public void VerifyDockThenAddNewPRO(String terminalcd,String SCAC,String TrailerNB) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException{
	SoftAssert  SAssert= new SoftAssert(); 
	page.SetLocation(terminalcd);
	page.EnterTrailer(SCAC,TrailerNB); 
	// dock all pro
	...
	Assert.assertEquals(page.ProListForm.findElement(By.xpath("div["+NEW2+"]/div/div[2]")).getText(),CurrentProH);
	...
	SAssert.assertEquals(AfterAddWb.get(7),BeforeAddWb.get(7),""+CurrentPro+" waybill Create_TS is wrong");
	SAssert.assertEquals(AfterAddWb.get(8),BeforeAddWb.get(8),""+CurrentPro+" waybill System_Insert_TS is wrong");
	...
	SAssert.assertTrue(Math.abs(f1.getTime()-d.getTime())<120000,"waybill table Waybill_Transaction_End_TS  "+f1+"  "+d+"  "+"   "+CurrentPro);
...
@Test (priority=3,dataProvider="4.52",dataProviderClass=DataForUS452.class)
	 public void DockAndReAdd(String terminalcd,String SCAC,String TrailerNB) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException{
		SoftAssert  SAssert= new SoftAssert(); 
		page.SetLocation(terminalcd);
	 	page.EnterTrailer(SCAC,TrailerNB);
	...
	@Test (priority=4,dataProvider="4.52",dataProviderClass=DataForUS452.class)
	 public void EmptyTrailerAddSomeThenDock(String terminalcd,String SCAC,String TrailerNB) throws AWTException, InterruptedException, ClassNotFoundException, SQLException, ParseException{
	  SoftAssert  SAssert= new SoftAssert(); 	
      page.SetLocation(terminalcd);
	  page.EnterTrailer(SCAC,TrailerNB);
	  // ADD PRO
